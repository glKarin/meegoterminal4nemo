...
#if QT_VERSION >= 0x040800 // karin: Check character width is not fixed.
...
#if QT_VERSION >= 0x040800 // karin: fixed character width is not fixed.
...
//  setMouseTracking(true);
  ...
  setInputMethodHints(inputMethodHints() | Qt::ImhNoAutoUppercase | Qt::ImhNoPredictiveText);
